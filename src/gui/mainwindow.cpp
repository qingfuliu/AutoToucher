...
void MainWindow::Init(){
    ...
    settingsIcon = new customIcon(":/icons/settings.svg", "settings", 5, this);
    ...
    layersIcon = new customIcon(":/icons/layers.svg", "layers", 5, this);
    ...
    bigIconButton *createNew = new bigIconButton(":/icons/create.png", "Create new", 10, this);
    createNew->setScale(0.9);
    bigIconButton *openFile = new bigIconButton(":/icons/open.png", "Open from file", 10, this);
